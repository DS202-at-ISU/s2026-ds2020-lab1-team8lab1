...
Cloned the test GitHub repository via RStudio. Saved a project locally
to a selected folder.

Step 12.4:

Made a local change and committed. Ran into an author authentication
error; fixed it by using:
